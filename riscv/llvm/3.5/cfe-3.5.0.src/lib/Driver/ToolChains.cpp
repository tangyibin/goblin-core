...
/*static*/ void Generic_GCC::GCCInstallationDetector::CollectLibDirsAndTriples(
  ...
  static const char *const RISCVTriples[]   = { "riscv-linux", 
                                                "riscv-linux-gnu", 
  ...
  case llvm::Triple::riscv:
    LibDirs.append(RISCVLibDirs, 
                   RISCVLibDirs + llvm::array_lengthof(RISCVLibDirs));
    TripleAliases.append(RISCVTriples,
                         RISCVTriples + llvm::array_lengthof(RISCVTriples));
    break;
