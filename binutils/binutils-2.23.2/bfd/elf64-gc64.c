/* GC64 [Goblin-Core] 64-bit ELF Support
...
static reloc_howto_type gc64_elf64_howto_rel[] =
{
	/* No Relocation */
  HOWTO (R_GC64_NONE,			/* type */
	 0,				/* rightshift */
	 ...
	 _bfd_gc64_generic_reloc,	/* special_function */
	 "R_GC64_NONE",			/* name */
...
#define TARGET_LITTLE_SYM		bfd_elf64_gc64_vec
#define TARGET_LITTLE_NAME		"elf64-gc64"
#define ELF_ARCH			bfd_arch_gc64
#define ELF_MACHINE_CODE		EM_GC64
#define ELF_MAXPAGESIZE			0x1
#define bfd_elf64_bfd_reloc_type_lookup bfd_generic_reloc_type_lookup
