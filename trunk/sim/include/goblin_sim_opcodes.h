...
/* --------------------------------------------- ISA FORMAT MACROS */
/* 
 * These are used to perform bitwise AND operations on instruction or 
 * immediate payloads in order to retrieve specific fields
 *
 */ 
...
#define GSIM_INST_IMM4_LOWER	0x00000000FFFFFFFF	/*! IMM: LOWER 4-BYTE IMMEDIATE */
#define GSIM_INST_IMM4_UPPER	0xFFFFFFFF00000000	/*! IMM: UPPER 4-BYTE IMMEDIATE */


#define	GSIM_REG_GCONST_TG	0x00000000000000FF	/*! REGISTER: GCONST: TASK GROUP */
#define	GSIM_REG_GCONST_TP	0x000000000000FF00	/*! REGISTER: GCONST: TASK PROCS */
#define	GSIM_REG_GCONST_TC	0x0000000000FF0000	/*! REGISTER: GCONST: TASK COUNT */
#define	GSIM_REG_GCONST_SID	0x00000000FF000000	/*! REGISTER: GCONST: SOCKET ID */
#define GSIM_REG_GCONST_NID	0x0000FFFF00000000	/*! REGISTER: GCONST: NODE ID */
#define GSIM_REG_GCONST_PID	0xFFFF000000000000	/*! REGISTER: GCONST: PARTITION ID */
