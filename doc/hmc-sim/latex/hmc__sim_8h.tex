...
\begin{DoxyCompactList}\small\item\em Instantiates a single leading edge and falling edge clock cycle on all devices. \end{DoxyCompactList}\end{DoxyCompactItemize}
