...
int \hyperlink{hmc__sim_8h_ad2eae4b1a8a1669e02d8c01d01e3c033}{hmcsim\-\_\-link\-\_\-config} (struct \hyperlink{structhmcsim__t}{hmcsim\-\_\-t} $\ast$hmc, uint32\-\_\-t src\-\_\-dev, uint32\-\_\-t dest\-\_\-dev, uint32\-\_\-t src\-\_\-link, uint32\-\_\-t dest\-\_\-link, hmc\-\_\-link\-\_\-def\-\_\-t type)
\begin{DoxyCompactList}\small\item\em Initializes individual device links for host-\/to-\/device or device-\/to-\/device configurations. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Attempts to write the value to the specified H\-M\-C device register for the target device using the side-\/band J\-T\-A\-G interface. \end{DoxyCompactList}\item 
int \hyperlink{hmc__sim_8h_ae145e2a3c9d47aea72f78bf7622ad81e}{hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize} (struct \hyperlink{structhmcsim__t}{hmcsim\-\_\-t} $\ast$hmc, uint32\-\_\-t dev, uint32\-\_\-t bsize)
\begin{DoxyCompactList}\small\item\em Sets the maximum request size for the target device. \end{DoxyCompactList}\item 
int \hyperlink{hmc__sim_8h_a92ec5bd21d7922a2e8c065d4ca2a50cf}{hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize} (struct \hyperlink{structhmcsim__t}{hmcsim\-\_\-t} $\ast$hmc, uint32\-\_\-t bsize)
\begin{DoxyCompactList}\small\item\em Sets the maximum request size for all the devices. \end{DoxyCompactList}\item 
int \hyperlink{hmc__sim_8h_a56e032ce38e246fb2e669159da7721e6}{hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize} (struct \hyperlink{structhmcsim__t}{hmcsim\-\_\-t} $\ast$hmc, uint32\-\_\-t dev, uint32\-\_\-t $\ast$bsize)
\begin{DoxyCompactList}\small\item\em Gets the maximum request size for the target device. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em $\ast$hmc} & is a pointer to a valid and initialized hmc structure. Must not be null. \\
\hline
{\em $\ast$packet} & is a pointer to an unsigned 8 byte location where the packet is located \\
\hline
...
\hline
{\em $\ast$length} & is a pointer to an unsigned 8 bit integer that contans the packet length \\
\hline
{\em $\ast$tag} & is a pointer to an unsigned 16 bit integer tha contains the tag \\
\hline
...
0 on success, nonzero otherwise 
\end{DoxyReturn}
\hypertarget{hmc__sim_8h_ad2eae4b1a8a1669e02d8c01d01e3c033}{\index{hmc\-\_\-sim.\-h@{hmc\-\_\-sim.\-h}!hmcsim\-\_\-link\-\_\-config@{hmcsim\-\_\-link\-\_\-config}}
\index{hmcsim\-\_\-link\-\_\-config@{hmcsim\-\_\-link\-\_\-config}!hmc_sim.h@{hmc\-\_\-sim.\-h}}
\subsubsection[{hmcsim\-\_\-link\-\_\-config}]{\setlength{\rightskip}{0pt plus 5cm}int hmcsim\-\_\-link\-\_\-config (
\begin{DoxyParamCaption}
\item[{struct {\bf hmcsim\-\_\-t} $\ast$}]{hmc, }
\item[{uint32\-\_\-t}]{src\-\_\-dev, }
\item[{uint32\-\_\-t}]{dest\-\_\-dev, }
\item[{uint32\-\_\-t}]{src\-\_\-link, }
\item[{uint32\-\_\-t}]{dest\-\_\-link, }
\item[{hmc\-\_\-link\-\_\-def\-\_\-t}]{type}
\end{DoxyParamCaption}
)}}\label{hmc__sim_8h_ad2eae4b1a8a1669e02d8c01d01e3c033}
...
{\em $\ast$hmc} & is a pointer to a valid and initialized hmc structure. Must not be null. \\
\hline
{\em src\-\_\-dev} & is the cube I\-D \mbox{[}C\-U\-B\mbox{]} of a source device. \\
\hline
{\em dest\-\_\-dev} & is the cube I\-D \mbox{[}C\-U\-B\mbox{]} of a destination device. \\
\hline
{\em src\-\_\-link} & is the link I\-D of the source link \\
\hline
{\em dest\-\_\-link} & is the link I\-D of the destination link \\
\hline
{\em type} & is one of H\-M\-C\-\_\-\-L\-I\-N\-K\-\_\-\-H\-O\-S\-T\-\_\-\-D\-E\-V or H\-M\-C\-\_\-\-L\-I\-N\-K\-\_\-\-D\-E\-V\-\_\-\-D\-E\-V \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 on success, nonzero otherwise 
...
0 on success, nonzero otherwise 
\end{DoxyReturn}
\hypertarget{hmc__sim_8h_a56e032ce38e246fb2e669159da7721e6}{\index{hmc\-\_\-sim.\-h@{hmc\-\_\-sim.\-h}!hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize}}
\index{hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize}!hmc_sim.h@{hmc\-\_\-sim.\-h}}
\subsubsection[{hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize}]{\setlength{\rightskip}{0pt plus 5cm}int hmcsim\-\_\-util\-\_\-get\-\_\-max\-\_\-blocksize (
\begin{DoxyParamCaption}
\item[{struct {\bf hmcsim\-\_\-t} $\ast$}]{hmc, }
\item[{uint32\-\_\-t}]{dev, }
\item[{uint32\-\_\-t $\ast$}]{bsize}
\end{DoxyParamCaption}
)}}\label{hmc__sim_8h_a56e032ce38e246fb2e669159da7721e6}
...
{\em dev} & is the target device cube I\-D \mbox{[}cub\mbox{]} to read from \\
\hline
{\em $\ast$bsize} & is a pointer to a valid uint32\-\_\-t location that will contain the max block size \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 on success, nonzero otherwise 
\end{DoxyReturn}
\hypertarget{hmc__sim_8h_a92ec5bd21d7922a2e8c065d4ca2a50cf}{\index{hmc\-\_\-sim.\-h@{hmc\-\_\-sim.\-h}!hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize}}
\index{hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize}!hmc_sim.h@{hmc\-\_\-sim.\-h}}
\subsubsection[{hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize}]{\setlength{\rightskip}{0pt plus 5cm}int hmcsim\-\_\-util\-\_\-set\-\_\-all\-\_\-max\-\_\-blocksize (
\begin{DoxyParamCaption}
\item[{struct {\bf hmcsim\-\_\-t} $\ast$}]{hmc, }
\item[{uint32\-\_\-t}]{bsize}
\end{DoxyParamCaption}
)}}\label{hmc__sim_8h_a92ec5bd21d7922a2e8c065d4ca2a50cf}
...
{\em $\ast$hmc} & is a pointer to a valid and initialized hmc structure. Must not be null. \\
\hline
{\em bsize} & is the target block size \mbox{[}32,64,128\mbox{]} \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 on success, nonzero otherwise 
\end{DoxyReturn}
\hypertarget{hmc__sim_8h_ae145e2a3c9d47aea72f78bf7622ad81e}{\index{hmc\-\_\-sim.\-h@{hmc\-\_\-sim.\-h}!hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize}}
\index{hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize@{hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize}!hmc_sim.h@{hmc\-\_\-sim.\-h}}
\subsubsection[{hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize}]{\setlength{\rightskip}{0pt plus 5cm}int hmcsim\-\_\-util\-\_\-set\-\_\-max\-\_\-blocksize (
\begin{DoxyParamCaption}
\item[{struct {\bf hmcsim\-\_\-t} $\ast$}]{hmc, }
\item[{uint32\-\_\-t}]{dev, }
\item[{uint32\-\_\-t}]{bsize}
\end{DoxyParamCaption}
)}}\label{hmc__sim_8h_ae145e2a3c9d47aea72f78bf7622ad81e}
